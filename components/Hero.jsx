    ...
    <div className="py-12 sm:py-16 w-full">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          className="max-w-2xl"
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-surface-border bg-surface-card/50 text-sm text-[#DCD1CC] font-medium mb-8">
            <span className="w-2.5 h-2.5 rounded-full bg-primary-500"></span>
            Fast & Easy Online 3D Printing Service
          </div>
          
          <h1 className="text-5xl sm:text-7xl font-extrabold text-white tracking-tight leading-[1.1] mb-6">
            Bambu P2S <span className="text-primary-500"><br/>3D Printing Service</span>
          </h1>
          
          <p className="text-lg sm:text-xl text-[#DCD1CC] mb-10 max-w-xl leading-relaxed font-light">
